...
public class MensagemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View arg1, ViewGroup arg2) {
        ...
        TextView titulo = (TextView) layout.findViewById(R.id.userFrom);
        final TextView descricao = (TextView) layout.findViewById(R.id.assunto);
        ...
        Button bt = (Button) layout.findViewById(R.id.mensagemCompleteDescriptionBT);
